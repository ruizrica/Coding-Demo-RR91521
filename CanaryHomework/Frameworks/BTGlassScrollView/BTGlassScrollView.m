...
- (id)initWithFrame:(CGRect)frame BackgroundImage:(UIImage *)backgroundImage blurredImage:(UIImage *)blurredImage viewDistanceFromBottom:(CGFloat)viewDistanceFromBottom foregroundView:(UIView *)foregroundView
{
    ...
    if (self) {
        ...
        _blurredBackgroundImageView.userInteractionEnabled = YES;
    }
    return self;
}

- (void)createViews:(UIImage *)backgroundImage blurredImage:(UIImage *)blurredImage viewDistanceFromBottom:(CGFloat)viewDistanceFromBottom foregroundView:(UIView *)foregroundView {
    ...
    if (animated) {
        ...
        if (previousBlurredBackgroundImageView.alpha == 1) {
            [UIView animateWithDuration:interval animations:^{
                ...
                [_normalBackgroundImageView setAlpha:previousBackgroundImageView.alpha];
        ...
        [_normalBackgroundImageView setImage:_backgroundImage];
...
{
    _normalBackgroundImageView = [[UIImageView alloc] initWithImage:_backgroundImage];
    [_normalBackgroundImageView setTranslatesAutoresizingMaskIntoConstraints:NO];
    [_normalBackgroundImageView setContentMode:UIViewContentModeScaleAspectFill];
    [_constraitView addSubview:_normalBackgroundImageView];
    ...
    [_constraitView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[_normalBackgroundImageView]|" options:0 metrics:0 views:NSDictionaryOfVariableBindings(_normalBackgroundImageView)]];
    [_constraitView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|[_normalBackgroundImageView]|" options:0 metrics:0 views:NSDictionaryOfVariableBindings(_normalBackgroundImageView)]];
