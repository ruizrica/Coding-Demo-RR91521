...
#define DEFAULT_BLUR_RADIUS 5 //was 40 and then was 5
...
#define DEFAULT_MAX_BACKGROUND_MOVEMENT_VERTICAL 10
#define DEFAULT_MAX_BACKGROUND_MOVEMENT_HORIZONTAL 50
...
@property (strong, nonatomic) UIImageView *normalBackgroundImageView;
@end
