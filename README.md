...
<br/>
After selecting a device from the tableview in **didSelectRowAtIndexPath** [[CoreDataController sharedCache] getReadingsForDevice] is called and passed into **DetailViewController**.  DetailViewController has property named Device of type **Device** that takes the passed object from ViewContoller.  With the local property self.device in **DetailViewController** the UI is drawn from the **Theme** class and added to the view as a subview.
<br/>
<br/>
